  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        ...
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><b>
    @foreach($des as $row)
    {{$row->header}}
    @endforeach
    </b></a>
...
<br>
    ...
    <div class="container">
    <h1 class="text-uppercase text-center mb-0">Cek Tarif Laut</h1>
    <br>
    <br>
  ...
  <footer class="footer text-center">
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small><p>&copy; 2018 <a class="link" onclick="login()">
    @foreach($des as $row)
    {{$row->header}}
    @endforeach
    </a>. All Rights Reserved. <a href="#">Joyoboyo Intermedia</a></p></small>
      </div>
    </div>

		...
		<div class="container-fluid">
			...
			<section class="card">
				...
				<div class="card-block">
                    ...
                    @endif
                    <a href="{{url('/tambahtransit')}}" class="btn btn-primary">Tambah Data</a>
                    <br><br>
                    <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                            	<a href="{{url('selesaitransit/'.$row->kode)}}" onclick="return confirm('Transit Selesai ?')" class="btn btn-success btn-sm">Selesai Transit</a>

			...
			<section class="tabs-section">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active show" id="tabs-1-tab-1">
                                               ...
                                               <p>
                                               <li>
                                                   Buka file <b>"template tarif darat.xlsx"</b> kemudian isi data seperti gambar dibawah perhatikan pada bagian <b>tarif,berat_minimal dan estimasi</b> hanyan diisi dengan angka saja. untuk id_cabang, isi dengan kode cabang sesuai dengan data id_cabang pada file data cabang yang telah di download
                                               </li><br>

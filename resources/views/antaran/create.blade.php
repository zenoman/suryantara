				...
				<form action="#" role="form" method="POST">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label class="form-label" for="exampleInputDisabled">Cari Pengirim</label>
						<select class="select2" id="caripengirim"></select>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label class="form-label" for="exampleInputDisabled">Kode Karyawan</label>
							<div class="input-group">
								<input type="text" class="form-control" id="kodekar" readonly>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="namakar" readonly>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="telpkar" readonly>
							</div>
						</div>
					</div>
					</div>
...
<script src="{{asset('assets/js/surat_antar.js')}}"></script>

				...
				<div class="row">
					<div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" placeholder="First Name" name="kode" value="{{$trflaut->kode}}">
							@if($errors->has('kode'))
					...
					<div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter email"  name="tujuan" value="{{$trflaut->tujuan}}">
						</fieldset>
					...
					<div class="col-lg-4">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control"  name="tarif" value="{{$trflaut->tarif}}">
						</fieldset>
						@if($errors->has('tarif'))
                                        <div class="alert alert-danger">
                                        {{ $errors->first('tarif')}}
					...
					<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" placeholder="First Name" name="berat_minimal" value="{{$trflaut->berat_min}}">
					...
					<div class="col-lg-6">
						<fieldset class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter email"  name="estimasi" value="{{$trflaut->estimasi}}">

					...
					<div class="col-md-9 col-sm-9">
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="nama_barang_darat"
								@if($row->pengiriman_via=='darat')value="{{$row->nama_barang}}"
								@endif>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-6">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="col-sm-4 col-md-4 form-control" 
								id="d_panjang_darat"
								@if($row->pengiriman_via=='darat') 
								value="{{$dmn[0]}}"
								@else
					...
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								id="jumlah_darat" 
								onkeypress="return isNumberKey(event)"
								@if($row->pengiriman_via=='darat')value="{{$row->jumlah}}"
								@endif>
					...
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								id="berat_darat" 
								onkeypress="return isNumberKey2(event)"
								@if($row->pengiriman_via=='darat')value="{{$row->berat}}"
								@endif>
								<div class="input-group-addon">Kg</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="form-control" 
								id="kota_asal_darat" 
								@if($row->pengiriman_via=='darat')value="{{$row->kota_asal}}"
								@endif>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="form-control" 
								id="n_pengirim_darat"
								@if($row->pengiriman_via=='darat')value="{{$row->nama_pengirim}}"
								@endif>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="form-control" 
								id="t_pengirim_darat" 
								@if($row->pengiriman_via=='darat')value="{{$row->telp_pengirim}}"
								@endif>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="alamat_pengirim_darat"
								@if($row->pengiriman_via=='darat')value="{{$row->alamat_pengirim}}"
								@endif>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="form-control" 
								id="n_penerima_darat" 
								@if($row->pengiriman_via=='darat')value="{{$row->nama_penerima}}"
								@endif>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								class="form-control" 
								id="t_penerima_darat" 
								@if($row->pengiriman_via=='darat')value="{{$row->telp_penerima}}"
								@endif>
							</div>
						</div>
					</div>
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="alamat_penerima_darat"
								@if($row->pengiriman_via=='darat')value="{{$row->alamat_penerima}}"
								@endif>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="biaya_kirim_darat" 
								onkeypress="return isNumberKey(event)"
								id="alamat_penerima_darat"
								@if($row->pengiriman_via=='darat')value="{{$row->biaya_kirim}}"
								@else
								value="0" 
								@endif>
							</div>
					...
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="biaya_packing_darat" 
								onkeypress="return isNumberKey(event)"
								@if($row->pengiriman_via=='darat')value="{{$row->biaya_packing}}"
								@else
								value="0" 
								@endif>
							</div>
					...
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
							...
							<div class="input-group">
								...
								type="text" 
								class="form-control" 
								id="biaya_asuransi_darat"
								onkeypress="return isNumberKey(event)"
								@if($row->pengiriman_via=='darat')value="{{$row->biaya_asuransi}}"
								@else
								value="0" 
								@endif>
							</div>
							...
							<table class="table table-bordered" id="estimasi">
								...
								<tbody>
									<tr>
										<td>Biaya Kirim</td>
										<td id="b_kirim_darat">
										@if($row->pengiriman_via=='darat'){{$row->biaya_kirim}}
										@else
										0 
										@endif
										</td>
									...
									<tr>
										<td>Biaya Packing</td>
										<td id="b_packing_darat">
										@if($row->pengiriman_via=='darat'){{$row->biaya_packing}}
										@else
										0 
										@endif
										</td>
									...
									<tr>
										<td>PPN</td>
										<td id="b_ppn_darat">
											@if($row->pengiriman_via=='darat'){{$row->biaya_ppn}}
										@else
										0 
										@endif
										</td>
									...
									<tr>
										<td colspan="2" class="text-center">
											<h3 id="total_darat">
												@if($row->pengiriman_via=='darat'){{$row->total_biaya}}
										@else
										0 
										@endif
											</h3>

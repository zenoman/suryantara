			...
			<section class="tabs-section">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active show" id="tabs-1-tab-1">
                                               ...
                                               <li>Download file template excel di tab sebelah bagian <b>import Excel.</b> Seperti gambar dibawah ini lalu klik pada bagian <b>Download Data Cabang</b> & <b>Download Template Excel</b>.</li><br>
                                               <img src="{{url('img/import_export/001.JPG')}}"  width="60%">
                                               <p>
                                               <li>
                                                   Buka file <b>"template tarif city kurir.xlsx"</b> kemudian isi data seperti gambar dibawah perhatikan pada bagian <b>tarif,berat_minimal dan estimasi</b> hanyan diisi dengan angka saja. untuk id_cabang, isi dengan kode cabang sesuai dengan data <b>id_cabang</b> pada file data cabang yang telah di download. terakhir untuk data <b>company</b> isi "Y" apabila tarif tersebut diperuntukan untuk company, dan isi "N" apabila untuk personal.
                                               </li><br>
                                               <img src="{{url('img/import_export/trfcity.PNG')}}">
                                               <p>
                                               ...
                                               <img src="{{url('img/import_export/001.JPG')}}"  width="60%"><p>
                                               <li>Untuk export tarif darat sangat sederhana.Lihat gambar dibawah ini.</li><br>
                                               <img src="{{url('img/import_export/002.JPG')}}"  width="60%">
                                               <br><p></p>
                                               <div class="alert alert-danger">
					...
					<div role="tabpanel" class="tab-pane fade" id="tabs-1-tab-2">
						<div class="panel-body" align="center">
							<a href="{{url('exsportcabang')}}" class="btn btn-primary">Download Data Cabang</a>
                                    <a href="{{url('trfcity/downloadtemplate')}}" class="btn btn-info">Download Template Excel</a>
                        </div>
                        <hr>
<p></p>
                        <div class="panel panel-default" align="center">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <form action="{{url('/trfcity/prosesimportexcel') }}" role="form" method="POST" enctype="multipart/form-data">
...
<a onclick="window.history.go(-1);" class="btn btn-danger">Kembali</a>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-1-tab-3">
						<div class="panel-body" align="center">
                                    <a href="{{url('trfcity/exporttarif')}}" class="btn btn-primary">Export Tarif City Kurir</a>
                        </div>
                        <hr>
<a onclick="window.history.go(-1);" class="btn btn-danger">Kembali</a>
                                    </div><!--.tab-pane-->

...
INSERT INTO `admin` (`id`, `kode`, `username`, `password`, `nama`, `telp`, `email`, `alamat`) VALUES
	...
	(9, '9876', 'abi', '25f9e794323b453885f5181f1b624d0b', 'abiihsan', '3242q34', '234', NULL);
/*!40000 ALTER TABLE `admin` ENABLE KEYS */;

-- membuang struktur untuk table kargo.detail_sj
...
-- Membuang data untuk tabel kargo.detail_sj: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel kargo.resi_pengiriman: ~5 rows (lebih kurang)
...
-- Membuang data untuk tabel kargo.surat_jalan: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel kargo.tarif_udara: ~9 rows (lebih kurang)
...
INSERT INTO `tarif_udara` (`id`, `kode`, `tujuan`, `airlans`, `perkg`, `minimal_heavy`, `biaya_dokumen`) VALUES
	(1, 'DD154', 'surabaya', 'asdaas', 23000, 12, 2000),
	(2, 'laut004', 'kediri  lagi', 'asdaas', 23000, 12, 2000),
	(3, 'AMQ1', 'ambon', 'LION PREMIUM(JT 86)', 15000, 50, 25000),
	(4, 'AMQ2', 'ambon', 'CITILINK', 15000, 50, 25000),
	(5, 'AMQ3', 'ambon', 'LION(Extra Monitor)', 15000, 50, 25000),
	(6, 'AMQ4', 'ambon', 'LION NOMRMAL RATE(ID 6614)', 15000, 110, 25000),
	(7, 'AMQ5', 'ambon', 'SRIWIJAYA', 15000, 110, 25000),
	(8, 'AMQ6', 'ambon', 'GARUDA VIA CGK', 15000, 110, 25000),
	(9, 'AMQ7', 'ambon', 'GARUDA VIA UPG/DIRECT', 15000, 110, 25000);
